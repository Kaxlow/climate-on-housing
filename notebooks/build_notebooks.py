...
PROVIDERS = {
    ...
    "redfin": {
        ...
        "patterns": ["redfin_%"],
        "primary_patterns": ["redfin_housing_market_monthly_counties", "redfin_property_types_monthly_counties", "redfin_price_drops_monthly_counties"],
        "key_candidates": [["PERIOD BEGIN", "REGION NAME", "PROPERTY TYPE"], ["PERIOD BEGIN", "REGION NAME"]],
        "date_candidates": ["PERIOD BEGIN", "PERIOD END", "LAST UPDATED"],
        "geo_candidates": ["REGION NAME", "REGION TYPE", "METRO"],
        "numeric_hints": ["MEDIAN SALE PRICE NSA ($)", "MEDIAN SALE PRICE PER SQ.FT. ($)", "MEDIAN SALE PRICE PER SQ.FT. YOY (%)", "HOMES SOLD", "INVENTORY", "MEDIAN DAYS ON MARKET (DAYS)"],
        "suppression_codes": ["", "NA", "null"],
        "grain": "One county-month observation, with a property-type dimension in the property-types source.",
