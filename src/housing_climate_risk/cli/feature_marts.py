...
def _catalog_rows() -> list[dict[str, object]]:
    ...
    rows = [
        ...
        ("county_housing_monthly", "median_ppsf_yoy", "Housing market", "Year-over-year change in median sale price per square foot.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric for All Residential rows.", "monthly", "Primary housing outcome"),
        ...
        ("county_housing_monthly", "avg_sale_to_list_yoy", "Housing market", "Year-over-year change in average sale-to-list ratio.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
        ("county_housing_monthly", "homes_sold_yoy", "Housing market", "Year-over-year change in homes sold.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
        ("county_housing_monthly", "inventory_yoy", "Housing market", "Year-over-year change in active inventory.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
        ("county_housing_monthly", "new_listings_yoy", "Housing market", "Year-over-year change in new listings.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
        ("county_housing_monthly", "median_dom_yoy", "Housing market", "Year-over-year change in median days on market.", "days", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
        ("county_housing_monthly", "price_drops_yoy", "Housing market", "Year-over-year change in share of listings with price drops.", "proportion", "mart.redfin_county_monthly", "Redfin text value parsed to numeric.", "monthly", "Event-window metric"),
    ...
    model_exclusions = {
        ...
        "risk_rating": "Used to define the modeling group, not as a predictor.",
        "risk_score": "Removed from county-relative PPSF model features.",
        "community_resilience_score": "Removed from county-relative PPSF model features.",
        "expected_annual_loss_score": "Removed from county-relative PPSF model features.",
        "social_vulnerability_score": "Removed from county-relative PPSF model features.",
        "median_home_value_usd": "Removed from county-relative PPSF model features.",
        "median_gross_rent_usd_month": "Removed from county-relative PPSF model features.",
        "median_owner_costs_mortgage_usd_month": "Removed from county-relative PPSF model features.",
        "price_drops_yoy": "Removed from county-relative PPSF model features.",
    ...
    con.execute(
        ...
        WITH raw_typed AS (
            SELECT
                ...
                period_end,
                try_cast(replace(MEDIAN_SALE_PRICE, ',', '') AS DOUBLE) AS median_sale_price_usd,
                try_cast(replace(MEDIAN_PPSF, ',', '') AS DOUBLE) AS median_ppsf_usd,
